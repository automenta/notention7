...
export interface EditorApi {
    ...
    getSemanticModalState: () => { open: boolean; type: 'tag' | 'template' | null };
...
export interface EditorPlugin {
     ...
     */
    onInput?: (event: React.FormEvent<HTMLDivElement>, editorApi: EditorApi) => boolean | void;
     ...
     * @returns `true` if the event was handled and should not be processed further.
     */
    onClick?: (event: React.MouseEvent<HTMLDivElement>, editorApi: EditorApi) => boolean | void;
}
