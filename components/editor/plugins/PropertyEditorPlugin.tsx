...
export const handleWidgetClick = (event: React.MouseEvent<HTMLDivElement>, editorApi: EditorApi) => {
...
export const PropertyEditor: React.FC<{ editorApi: EditorApi }> = ({ editorApi }) => {
    ...
    const handleSave = (widgetId: string, key: string, operator: string, values: string[]) => {
