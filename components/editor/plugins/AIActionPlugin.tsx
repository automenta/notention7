...
import {AIAction, generateContentStream,} from '@/services/languageModelService.ts';
import {
    ChevronDownIcon,
    ClipboardIcon,
    ...
    return (
        <>
            <div className="relative flex items-center gap-2 mr-4" ref={menuRef}>
                ...
                {isMenuOpen && (
                    <div
                        className="absolute top-full right-0 mt-2 w-56 bg-gray-700 border border-gray-600 rounded-lg shadow-lg z-50">
                        <ul className="py-1">
