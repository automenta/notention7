                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {suggestions.tags.map((tag) => (
                      <label key={tag} className="flex items-center gap-2 p-2 rounded-md bg-gray-700/50 cursor-pointer">
                        <input
                          type="checkbox"
                 ...
                 <div>
                  ...
                  <div className="space-y-2">
                    {suggestions.properties.map((prop, i) => (
                      <label key={`${prop.key}-${i}`} className="flex items-center gap-2 p-2 rounded-md bg-gray-700/50 cursor-pointer">
                         <input
                          type="checkbox"
