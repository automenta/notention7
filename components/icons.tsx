...
// Toolbar Icons
export const BoldIcon = (props: IconProps) => <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                   fill="currentColor">
    <path d="M8 11h4.5a2.5 2.5 0 100-5H8v5zm10 4.5a4.5 4.5 0 01-4.5 4.5H6V11h8.5a4.5 4.5 0 010 9z"/>
</svg>;
export const ItalicIcon = (props: IconProps) => <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                     fill="currentColor">
    <path d="M10 5h2.5l-4.5 14H5.5l4.5-14zM14.5 5H17l-4.5 14h-2.5l4.5-14z"/>
</svg>;
export const UnderlineIcon = (props: IconProps) => <svg {...props} xmlns="http://www.w3.org/2000/svg"
                                                        viewBox="0 0 24 24" fill="currentColor">
    <path d="M6 19h12v2H6v-2zM8 5v9a4 4 0 008 0V5h-2v9a2 2 0 01-4 0V5H8z"/>
</svg>;
export const StrikethroughIcon = (props: IconProps) => <svg {...props} xmlns="http://www.w3.org/2000/svg"
                                                            viewBox="0 0 24 24" fill="currentColor">
    <path
...
export const Heading1Icon = (props: IconProps) => <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                       fill="currentColor">
    <path d="M3 3h2v8h4V3h2v18H9v-8H5v8H3V3zm12 4h-2v14h-2V7h-2V5h6v2zm4 8v-2h-2v2h2zm0 2h-2v2h2v-2z"/>
</svg>;
export const Heading2Icon = (props: IconProps) => <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                       fill="currentColor">
    <path
        d="M3 3h2v8h4V3h2v18H9v-8H5v8H3V3zm11 14.5a4.5 4.5 0 01-4.5-4.5V11h2v2a2.5 2.5 0 005 0V7h-6V5h8v8.5a4.5 4.5 0 01-4.5 4.5z"/>
</svg>;
export const Heading3Icon = (props: IconProps) => <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                       fill="currentColor">
    <path
...
export const ListUlIcon = (props: IconProps) => <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                     fill="currentColor">
    <path
...
export const ListOlIcon = (props: IconProps) => <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                     fill="currentColor">
    <path
...
export const QuoteIcon = (props: IconProps) => <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                    fill="currentColor">
    <path d="M6 17h3l2-4V7H5v6h3l-2 4zm8 0h3l2-4V7h-6v6h3l-2 4z"/>
</svg>;
export const CodeBlockIcon = (props: IconProps) => <svg {...props} xmlns="http://www.w3.org/2000/svg"
                                                        viewBox="0 0 24 24" fill="currentColor">
    <path
...
export const LinkIcon = (props: IconProps) => <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                   fill="currentColor">
    <path
...
export const HorizontalRuleIcon = (props: IconProps) => <svg {...props} xmlns="http://www.w3.org/2000/svg"
                                                             viewBox="0 0 24 24" fill="currentColor">
