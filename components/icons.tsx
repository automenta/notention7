...
export const CodeIcon = (props: IconProps) => <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M8.29 16.71L3.59 12l4.7-4.71L9.7 8.7l-3.3 3.3 3.3 3.3-1.41 1.41zm7.42 0L20.41 12l-4.7-4.71-1.41 1.41 3.3 3.3-3.3 3.3 1.41 1.41z"/></svg>;
