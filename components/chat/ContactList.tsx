        ...
        <div className="h-full flex flex-col border-r border-gray-700/50 bg-gray-900/50">
            <div className="p-4 flex-shrink-0 border-b border-gray-700/50">
                <form onSubmit={handleAddContact} className="flex gap-2">
                    <input type="text" value={newContactNpub} onChange={e => setNewContactNpub(e.target.value)}
                    ...
                    <button type="submit" className="p-2 bg-blue-600 rounded-md hover:bg-blue-700"><UserPlusIcon
            ...
            <div className="flex-grow overflow-y-auto">
                ...
                {contacts.map(contact => {
                    ...
                    return (
                        <div key={contact.pubkey} onClick={() => onSelectContact(contact)}
                            ...
                            <img
                                src={profile?.picture || `https://api.dicebear.com/8.x/bottts-neutral/svg?seed=${contact.pubkey}`}
