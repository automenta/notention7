...
import type {AppSettings, ContentNode, EditorApi, EditorPlugin, Note} from '@/types';
import {type EditorAction, editorReducer, type EditorState,} from './reducers/editorReducer';
