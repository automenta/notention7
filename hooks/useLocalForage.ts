...
export function useLocalForage<T,>(key: string, initialValue: T): [T, Dispatch<SetStateAction<T>>, boolean] {
    ...
    localforage.getItem<T>(key).then(value => {
      if (isMounted) {
        if (value !== null) {
          ...
          if (Object.prototype.toString.call(initialValue) === '[object Object]' && Object.prototype.toString.call(value) === '[object Object]') {
             setStoredValue({ ...initialValue as object, ...value as object } as T);
          } else {
