...
describe('NoteListItem', () => {
    it('renders the note title and content preview', () => {
        render(<NoteListItem note={mockNote} isSelected={false} onSelect={() => {
        }} onDelete={() => {
        }}/>);
    ...
    it('renders "Untitled Note" if the note has no title', () => {
        ...
        render(<NoteListItem note={noteWithoutTitle} isSelected={false} onSelect={() => {
        }} onDelete={() => {
        }}/>);
    ...
    it('renders "No content" if the note content is empty', () => {
        ...
        render(<NoteListItem note={noteWithoutContent} isSelected={false} onSelect={() => {
        }} onDelete={() => {
        }}/>);
    ...
    it('shows the world icon for a published note', () => {
        render(<NoteListItem note={mockPublishedNote} isSelected={false} onSelect={() => {
        }} onDelete={() => {
        }}/>);
    ...
    it('applies selected styles when isSelected is true', () => {
        const {container} = render(<NoteListItem note={mockNote} isSelected={true} onSelect={() => {
        }} onDelete={() => {
        }}/>);
    ...
    it('applies hover styles when isSelected is false', () => {
        const {container} = render(<NoteListItem note={mockNote} isSelected={false} onSelect={() => {
        }} onDelete={() => {
        }}/>);
